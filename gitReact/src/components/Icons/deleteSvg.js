...
export const deleteSvg = () => {
    return (
        <svg id="Layer_1" height="20px" width="20px" version="1.1" viewBox="0 0 64 64" >
            <g><g id="Icon-Trash" transform="translate(232.000000, 228.000000)">
            ...
            <path class="st0" d="M-191-172.1h-18c-2.4,0-4.5-2-4.7-4.4l-2.8-36l3-0.2l2.8,36c0.1,0.9,0.9,1.6,1.7,1.6h18     c0.9,0,1.7-0.8,1.7-1.6l2.8-36l3,0.2l-2.8,36C-186.5-174-188.6-172.1-191-172.1" id="Fill-11" /></g></g>
            </svg>
    )
}
